...
import doodleCactus from '@/assets/doodle_cactus.png';
            ...
            <div className={` px-0  w-full  min-h-screen z-20 relative flex flex-col items-center justify-center `}>
                ...
                >
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-baseline gap-4 md:-mt-4">
                        ...
                        {/* Doodle Cactus (Floating) */}
                        {/* <motion.img
                            style={{ x: useTransform(mouseX, [-0.5, 0.5], [-30, 30]), y: useTransform(mouseY, [-0.5, 0.5], [-30, 30]) }}
                            src={doodleCactus}
                            alt="Cactus doodle"
                            className="w-12 md:w-16 opacity-90 absolute top-[30%] right-[10%] md:right-[-50px] transform rotate-12 z-0 pointer-events-none"
                        /> */}

                        {/* THAT */}
                        <span className="text-[3rem] md:text-[5rem] lg:text-[7rem] font-serif italic text-accent drop-shadow-sm z-10 transform -translate-y-2 md:translate-y-0">
                            that
                        </span>

                        {/* MATTERS */}
                        <span className="text-[4.5rem] md:text-[7.5rem] lg:text-[9.5rem] text-[#fbf8f3] transform rotate-1 origin-bottom-left tracking-tighter hover:scale-105 hover:text-accent transition-transform duration-300 inline-block cursor-default">
                            MATTERS
                        </span>
                    </div>
                </motion.div>
                ...
                <div className="mt-16 md:mt-24 flex flex-col md:flex-row items-center gap-8 md:gap-16 z-20 max-w-5xl mx-auto w-full px-4">
                    ...
                    {/* <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                        <MagneticButton href="#services">
                            <span className="px-8 py-3 rounded-full bg-[#FEF7CD] text-[#1a1a1a] font-bold text-lg hover:bg-yellow-400 transition-colors shadow-sm inline-block">
                                Learn more
                            </span>
                        </MagneticButton>
