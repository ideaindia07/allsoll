        ...
        <div
            ...
            <div className={` px-0  w-full  min-h-screen z-20 relative flex flex-col items-center justify-center `}>
                ...
                >
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-baseline gap-4 md:-mt-4 relative z-10">
                        ...
                        {/* MATTERS */}
                        <span className="text-[4.5rem] md:text-[7.5rem] lg:text-[10.5rem] text-[#fbf8f3] transform rotate-1 origin-bottom-left tracking-tighter hover:text-accent transition-transform duration-300 inline-block cursor-default">
                            MATTERS
                        </span>
                    </div>
                </motion.div>
