  ...
  return (
    <div ref={triggerRef} className="relative w-full h-[400vh] bg-bg-primary z-20">
      ...
      >
        ...
        {/* Stage 3 Canvas Wrapper */}
        <div
          className={`absolute w-full h-full max-w-[1200px] max-h-[800px] mx-auto transition-all duration-800 ease-[cubic-bezier(0.16,1,0.3,1)] ${
            showStage3 || scrollProgress >= 0.82
              ? 'opacity-100 scale-100 visible'
              : 'opacity-0 scale-95 invisible'
          }`}
        >
